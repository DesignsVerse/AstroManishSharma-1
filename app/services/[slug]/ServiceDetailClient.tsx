...
export default function ServiceDetailClient({ slug }: ServiceDetailClientProps) {
  ...
  const services: Service[] = language === 'en' ? enServices : hiServices;
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  name: 'Rajesh K.',
                  role: language === 'en' ? 'Satisfied Client' : 'संतुष्ट ग्राहक',
                  quote: language === 'en'
                    ? 'This puja completely transformed my career prospects. The guidance was accurate and impactful.'
                    : 'इस पूजा ने मेरी करियर संभावनाओं को पूरी तरह से बदल दिया। मार्गदर्शन सटीक और प्रभावशाली था।',
                },
                {
                  name: 'Sunita M.',
                  role: language === 'en' ? 'Satisfied Client' : 'संतुष्ट ग्राहक',
                  quote: language === 'en'
                    ? 'The Career Job Puja brought immense positivity and opened new job opportunities.'
                    : 'करियर नौकरी पूजा ने असीम सकारात्मकता लाई और नई नौकरी के अवसर खोले।',
                },
                {
                  name: 'Amit P.',
                  role: language === 'en' ? 'Satisfied Client' : 'संतुष्ट ग्राहक',
                  quote: language === 'en'
                    ? 'Highly recommend this puja for anyone seeking professional growth.'
                    : 'पेशेवर विकास चाहने वाले किसी भी व्यक्ति के लिए इस पूजा की अत्यधिक अनुशंसा करता हूँ।',
                },
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-20">
              ...
              <p className="text-xl text-gray-600">
                {language === 'en' ? 'Get started in just a few easy steps' : 'बस कुछ आसान चरणों में शुरू करें'}
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl font-bold text-white mb-6">
                {language === 'en' ? 'Ready to Transform Your Life?' : 'अपने जीवन को बदलने के लिए तैयार हैं?'}
              </h2>
