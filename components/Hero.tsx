...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[80vh] pt-16 flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative w-full max-w-[300px] sm:max-w-[400px] lg:max-w-lg mx-auto">
              <motion.div
              ...
              >
                ...
                <motion.div 
                  className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm px-4 py-2 sm:px-6 sm:py-3 rounded-xl shadow-md"
          ...
          <motion.div 
            className="order-2 text-center lg:text-left space-y-6"
            initial="hidden"
          ...
          >
            <motion.div className="space-y-4" variants={containerVariants}>
              ...
              >
                <span className="block bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-[#F0DF20]">
                  {content.hero.title.split(' ').slice(0, 3).join(' ')}
                </span>
                <span className="text-[#F0DF20]">{content.hero.title.split(' ').slice(3).join(' ')}</span>
              </motion.h1>
              <motion.p 
                className="text-base sm:text-lg text-gray-600 max-w-xl leading-relaxed mx-auto lg:mx-0"
              >
            ...
            >
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
                <Button 
                  size="lg"
                  className="w-full sm:w-auto bg-[#F0DF20] hover:bg-[#F0DF20]/90 text-gray-900 font-bold px-6 sm:px-8 py-5 sm:py-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 group"
                >
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
                <Button 
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white font-bold px-6 sm:px-8 py-5 sm:py-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 group"
                >
